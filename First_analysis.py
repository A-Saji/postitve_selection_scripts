...
motifs_path = "/home/bgopikrishnan/Desktop/new_working/XSTREME_input_putative_negative/"+sys.argv[1]+"/xstreme_DE/xstreme.txt"
meme_motifs_path = "/home/bgopikrishnan/Desktop/new_working/XSTREME_input_putative_negative/"+sys.argv[1]+"/xstreme_DE/meme_out/meme.txt"
...
for i in l3:
    # print(i)
    if "Seita" and "Pavir" and "GRMZM" and "ELECO" and "Misin" and "Oropetium" and "Urofu" in i:
        # print("True")
        ans.append("True")
    else:
        # print("False")
